...
https://github.com/novelinux/linux-4.x.y/tree/master/mm/res/vm_area_struct.png

每个区域表示为vm_area_struct的一个实例，如下所示:

https://github.com/novelinux/linux-4.x.y/tree/master/include/linux/mm_types_h/vm_area_struct.md
